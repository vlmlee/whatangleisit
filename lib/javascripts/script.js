...
var viewState = { analog: false, absolute: true, darkMode: true, hide: false };
...
function setAnalog(value) {
    ...
    if (value) {
        $('.analog-clock').show();
        $('.digital-clock').hide();
        $('.clock-mode').find('.absolute').prop('disabled', true);
        $('.clock-mode').find('.relative').prop('disabled', true);
    } else {
        $('.analog-clock').hide();
        $('.digital-clock').show();
        $('.clock-mode').find('.relative').prop('disabled', false);
        $('.clock-mode').find('.absolute').prop('disabled', false);
    }
}
...
function setDarkMode(value) {
    ...
    $('.dark-mode')
        .toggleClass('is-dark', value);
    $('.arc-hour, .arc-outer, .arc-mid, .arc-inner').css({
